...
{
	// NOTE: Command: PS C:\Users\leogr\OneDrive\Documents\Sagemount\Web_Scraper\CrowLeer-master\x64\Debug> ./CrowLeer.exe -l "CLlogs2.txt" -u "https://www.scorpion.co/" --depth 1 --thread 4 -o ./outputs -x -S
	...
	out << "THIS" << save << base.check(saveCondition) << "\n";
